...
#define WIZ_RDY_DM_ALG_HIZ         (0x00u)
#define WIZ_RDY_DM_DIG_HIZ         (0x01u)
#define WIZ_RDY_DM_RES_UP          (0x02u)
#define WIZ_RDY_DM_RES_DWN         (0x03u)
#define WIZ_RDY_DM_OD_LO           (0x04u)
#define WIZ_RDY_DM_OD_HI           (0x05u)
#define WIZ_RDY_DM_STRONG          (0x06u)
#define WIZ_RDY_DM_RES_UPDWN       (0x07u)
